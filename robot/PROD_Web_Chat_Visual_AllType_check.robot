...
# Oem : SYNALIO
# cid : 1906
# app : Web_auto_test (Scenario V2)

*** Variables ***
${test_page}=    https://eugenechangresola.github.io/WebbotPages/PROD/SYNALIO/auto/
...
Chat Visual:Type 1
    ...
    Capture Element Screenshot    css=div.window-box    PROD_ChatVisual_Type1.png
...
Chat Visual:Type 2
    ...
    Sleep    2
    Capture Element Screenshot    css=div.window-box    PROD_ChatVisual_Type2.png
    # Set time out for capturing process
    Sleep    2
    Click Element    id=btn-open-close
...
Chat Visual:Type 3
    ...
    Sleep    2
    Capture Element Screenshot    css=div.window-box    PROD_ChatVisual_Type3A.png
    # Set time out for capturing process
    Sleep    2
    Click Element    id=synalio-visual-close
    Wait Until Element Is Not Visible    css=div.img-box
    Sleep    2
    Capture Element Screenshot    css=div.window-box    PROD_ChatVisual_Type3A_minimized.png
    # Set time out for capturing process
    Sleep    2
    Click Element    css=div.btn-set-box
    Wait Until Element Is Visible    css=body > div > div.outer-box > div.header-box > div.inner-header-set-box > div.name-box
...
Chat Visual:Type 3 (minimize to image visual)
    Open Browser    https://eugenechangresola.github.io/WebbotPages/PROD/SYNALIO/auto/index_scenario_v1.html?chatvisual=3    chrome
    Wait Until Page Contains Element    id=synalio-iframe
    Select Frame    id=synalio-iframe
    Wait Until Element Is Visible    css=div.img-box
    Sleep    2
    Capture Element Screenshot    css=div.window-box    PROD_ChatVisual_Type3B.png
    # Set time out for capturing process
    Sleep    2
    ...
    Sleep    2
    Capture Element Screenshot    css=div.window-box    PROD_ChatVisual_Type3B_minimized.png
    # Set time out for capturing process
    Sleep    2
    Click Element    css=div.img-box
    Wait Until Element Is Visible    css=body > div > div.outer-box > div.header-box > div.inner-header-set-box > div.name-box

...
*** Test Cases ***
Chat bot behavior - Scenario V1 : SCENARIO FLOW
...
Chat bot behavior - Scenario v1 : ACTION
...
Chat bot behavior - Scenario V2 : SCENARIO FLOW
    Open Browser    https://eugenechangresola.github.io/WebbotPages/STG/AUTO/V2/?test=messageflow    Chrome
    Wait Until Element Is Visible    id=divtitle
    Wait Until Page Contains Element    id=synalio-iframe
    Select Frame    id=synalio-iframe
    Wait Until Element Is Visible    css=body > div.window-box
...
Chat bot behavior - Scenario V2 : ACTION
    Open Browser    https://eugenechangresola.github.io/WebbotPages/STG/AUTO/V2/?test=action    Chrome
    Wait Until Element Is Visible    id=divtitle
    Wait Until Page Contains Element    id=synalio-iframe
    Select Frame    id=synalio-iframe
    Wait Until Element Is Visible    css=body > div.window-box
